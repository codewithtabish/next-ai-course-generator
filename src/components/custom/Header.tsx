...
const AppHeader = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Set scroll position threshold for the header to become sticky
  ...
  return (
    <header
      className={`border-b-[1px] dark:border-gray-[10]  z-50 transition-all duration-300 ${
        isSticky
          ? "relative top-0 bg-gray=50  dark:bg-gray-900 shadow-2xl"
          : "relative"
      }`}
    >
